    ...
    <div class="container mx-auto mt-24 flex px-5 md:px-0">
        <the-form  class="mx-auto" :title="locales.edit_task" @submit="editTask">
            ...
            <div class="w-full flex flex-col md:flex-row">
                <the-input type="date" id="date" :title="locales.date" :model-value="date" @update:modelValue="handleDateChange" class="basis-1/2 md:mr-5" :error="useFilterErrorMessages(errors,messages.DATE_CANNOT_BE_EMPTY)"></the-input>
            ...
            <div class="w-full mt-5 justify-end flex flex-col md:flex-row">
                ...
                <primary-button :title="locales.save" @click.prevent="editTask" type="button"></primary-button>
            </div>
        </the-form>
    </div>
</div>
